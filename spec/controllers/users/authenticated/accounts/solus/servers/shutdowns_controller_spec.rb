...
describe Users::Authenticated::Accounts::Solus::Servers::ShutdownsController do
  ...
  context "with a valid account" do
    ...
    context "when the user has server access" do
      context "and a server that is active" do
        ...
        before { stub_solus_request('vserver-shutdown', {vserverid: server.vserver_id}, double(success?: true)) }
