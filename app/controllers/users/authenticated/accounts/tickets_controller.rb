module Users
  module Authenticated
    module Accounts
      class TicketsController < Accounts::ApplicationController
        decorates_assigned :tickets, :ticket

        power :account_tickets, context: :load_account, as: :tickets_scope, map: { [:new, :create] => :creatable_account_tickets }
        ...
        def new
          current_power.account_tickets!(account)
        ...
        def create
          ...
          ticket_creator.on(:create_success) do |ticket|
            ...
            redirect_to [:users, @account, ticket]
          end
