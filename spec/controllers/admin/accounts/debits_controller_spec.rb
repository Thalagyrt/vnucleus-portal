...
describe Admin::Accounts::DebitsController do
  ...
  context "with an admin user" do
    ...
    describe "#create" do
      context "with valid data" do
        before { post :create, account_id: account.to_param, transaction_form: { amount_dollars: '5', description: 'Sudden debit' } }
      ...
      context "with invalid data" do
        before { post :create, account_id: account.to_param, transaction_form: { amount_dollars: '0', description: 'Zero debit' } }
