module Users
  module Authenticated
    module Accounts
      module Solus
        module Servers
          class ShutdownsController < ::Users::Authenticated::Accounts::Solus::Servers::ApplicationController
            before_filter :ensure_active

            def create
              if power_service.shutdown
                flash[:notice] = "Your server is now shutting down."
              end
