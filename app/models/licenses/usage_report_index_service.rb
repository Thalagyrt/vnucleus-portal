module Licenses
  class UsageReportIndexService
    ...
    def usage_reports
      dates.map { |d| usage_report_class.new(usages_scope: usages_scope, products_scope: products_scope, start_date: d) }
    end

    private
    attr_reader :usages_scope, :products_scope, :usage_report_class
